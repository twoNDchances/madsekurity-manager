...
<body id="body" class="t43" style="min-width:100%;Margin:0px;padding:0px;background-color:#F9F9F9;">
    <div class="t42" style="background-color:#F9F9F9;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
            <tr>
                <td class="t41"
                    style="font-size:0;line-height:0;mso-line-height-rule:exactly;background-color:#F9F9F9;background-image:none;background-repeat:repeat;background-size:auto;background-position:center top;"
...
<![endif]-->
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" align="center"
                        ...
                        <tr>
                            <td>
                                <div class="t35"
                                    style="mso-line-height-rule:exactly;mso-line-height-alt:70px;line-height:70px;font-size:1px;display:block;">
                                    &nbsp;&nbsp;</div>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table class="t39" role="presentation" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td width="400" class="t38" style="width:400px;">
                                            <table class="t37" role="presentation" cellpadding="0" cellspacing="0"
                                                width="100%" style="width:100%;">
                                                <tr>
                                                    <td class="t36"
                                                        style="border:1px solid #CECECE;overflow:hidden;background-color:#FFFFFF;padding:50px 40px 40px 40px;border-radius:20px 20px 20px 20px;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="t1"><a href="#"
                                                                                                ...
                                                                                                target="_blank"><img
                                                                                                    ...
                                                                                                    height="72.46875"
                                                                                                    alt=""
                                                                                                    src="https://8d8642d0-7a2b-4e8d-a549-ffd821a5382f.b-cdn.net/e/97da0958-9f75-43ad-b37e-5479ed85a70b/654ce9da-1ded-43a7-81ff-e191fcad07a3.png" /></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="154" class="t27"
                                                                                ...
                                                                                <table class="t26" role="presentation"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="t25"
                                                                                            style="overflow:hidden;background-color:#0055FF;text-align:center;line-height:40px;mso-line-height-rule:exactly;mso-text-raise:8px;border-radius:8px 8px 8px 8px;">
                                                                                            <a class="t23"
                                                                                                href="{{ route('manager.verify', ['email' => $email, 'token' => $token]) }}"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table class="t34" role="presentation"
                                                                        ...
                                                                        style="Margin-left:auto;Margin-right:auto;">
                                                                        <tr>
                                                                            <td width="318" class="t33"
                                                                                style="width:318px;">
                                                                                <table class="t32" role="presentation"
                                                                                    cellpadding="0" cellspacing="0"
                                                                                    width="100%" style="width:100%;">
                                                                                    <tr>
                                                                                        <td class="t31">
