...
class BehaviorService
{
    ...
    public static function getResourceUrl(Behavior $behavior)
    {
        ...
        {
            case 'defender':
                $routePrefix = 'filament.manager.implementations.resources.' . Str::plural($resourceName);
                break;
            case 'group':
            case 'rule':
            case 'action':
                $routePrefix = 'filament.manager.initializations.resources.' . Str::plural($resourceName);
                break;
            case 'target':
            case 'engine':
